...
importers:
  ...
  .:
    dependencies:
      ...
      vue-axios:
        specifier: ^3.5.2
        version: 3.5.2(axios@1.10.0)(vue@3.5.16)
    devDependencies:
      '@babel/eslint-parser':
        specifier: ^7.27.1
      ...
      vue-test-utils:
        ...
        version: 1.0.0-beta.11(vue-template-compiler@2.7.16)(vue@3.5.16)
...
packages:
  ...
  htmlhint@1.6.1:
    resolution: {integrity: sha512-vpMr2oduyKzliyYniKJ9/fGQTfQ7hOzU9px6JtA7hSFQgGiG+sk9i+1cmwssU31/ws/oaPzKBsFsFM8nvpywCQ==}
    engines: {node: '>=20'}
    hasBin: true
  ...
  vue-test-utils@1.0.0-beta.11:
    resolution: {integrity: sha512-KTBx60NtuKAXyMkl798kyCUThqExeCSB4MJk/J+wQp3+ul3HKVgN1ngx4NFu0Py9gJyIwat5EgV+EOJGRvS4xQ==}
    deprecated: 'VUE-TEST-UILS WARN: vue-test-utils has moved to a scoped package. The new repository is available @vue/test-utils. To install the new package, run npm install --save-dev @vue/test-utils'
    peerDependencies:
      vue: 2.x
...
snapshots:
  ...
  vue-axios@3.5.2(axios@1.10.0)(vue@3.5.16):
    dependencies:
      axios: 1.10.0
      vue: 3.5.16
  ...
  vue-test-utils@1.0.0-beta.11(vue-template-compiler@2.7.16)(vue@3.5.16):
    dependencies:
      lodash: 4.17.21
      vue: 3.5.16
      vue-template-compiler: 2.7.16
